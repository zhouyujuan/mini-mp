...
__DEFINE__(1625038545731, function(require, module, exports) {
/**
 * 提供 npm 包引用的入口
 */
var COS = require('./sdk/cos');
module.exports = COS;
}, function(modId) {var map = {"./sdk/cos":1625038545732}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1625038545732, function(require, module, exports) {
...
}, function(modId) { var map = {"./util":1625038545733,"./event":1625038545734,"./task":1625038545735,"./base":1625038545737,"./advance":1625038545740,"../package.json":1625038545738}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1625038545733, function(require, module, exports) {
...
__DEFINE__(1625038545734, function(require, module, exports) {
...
__DEFINE__(1625038545735, function(require, module, exports) {
...
}, function(modId) { var map = {"./session":1625038545736,"./util":1625038545733}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1625038545736, function(require, module, exports) {
var util = require('./util');
// 按照文件特征值，缓存 UploadId
...
}, function(modId) { var map = {"./util":1625038545733}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1625038545737, function(require, module, exports) {
var pkg = require('../package.json');
...
}, function(modId) { var map = {"../package.json":1625038545738,"./util":1625038545733,"./select-stream":1625038545739}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1625038545738, function(require, module, exports) {
module.exports = {
  "_from": "cos-nodejs-sdk-v5@^2.9.12",
  "_id": "cos-nodejs-sdk-v5@2.9.20",
  "_inBundle": false,
  "_integrity": "sha1-ZMarkK3yfCT6CdJX7M0osIsvoGU=",
  "_location": "/cos-nodejs-sdk-v5",
  "_phantomChildren": {},
  "_requested": {
    "type": "range",
    "registry": true,
    "raw": "cos-nodejs-sdk-v5@^2.9.12",
  ...
  "_resolved": "https://npm.baijia.com/cos-nodejs-sdk-v5/-/cos-nodejs-sdk-v5-2.9.20.tgz",
  "_shasum": "64c6ab90adf27c24fa09d257eccd28b08b2fa065",
  "_spec": "cos-nodejs-sdk-v5@^2.9.12",
...
__DEFINE__(1625038545739, function(require, module, exports) {
...
}, function(modId) { var map = {"util":1625038545733,"./util":1625038545733}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1625038545740, function(require, module, exports) {
var session = require('./session');
var fs = require('fs');
...
}, function(modId) { var map = {"./session":1625038545736,"./async":1625038545741,"./event":1625038545734,"./util":1625038545733}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1625038545741, function(require, module, exports) {
...
return __REQUIRE__(1625038545731);
})()
