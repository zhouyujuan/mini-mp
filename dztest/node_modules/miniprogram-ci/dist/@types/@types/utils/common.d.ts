...
export declare const getAllPagesInfo: (appJSON: any) => IPageInfo[];
...
export declare function getAllTargetTypeFilesWithOtherTypeFilesOfSameName(project: MiniProgramCI.IProject, targetType: string, otherTypes: string[], filter: string): string[];
